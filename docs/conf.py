...
# -*- coding: utf-8 -*-
#
# s3vaultlib documentation build configuration file, created by
...
sphinx.apidoc.main(argv=['_','-f', '-o', os.path.join(project_root, 'docs'),
                   os.path.join(project_root, '''s3vaultlib''')])
...
project = u'S3Vault Library'
copyright = u"2017, Giuseppe Chiesa"
...
version = s3vaultlib.__version__
# The full version, including alpha/beta/rc tags.
release = s3vaultlib.__version__
...
htmlhelp_basename = 's3vaultlibdoc'
...
# [howto/manual]).
latex_documents = [
    ('index', 's3vaultlib.tex',
     u'S3Vault Library Documentation',
